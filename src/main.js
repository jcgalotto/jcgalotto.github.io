...
import {
    ...
    addTechnicalNote,
    resetTechnicalNotes
} from './ui/dashboard.js?v=5';
import { generateExchangeRateChart, generateComparisonChart, generateGapChart } from './ui/charts.js?v=4';
import { DatePicker } from './ui/datepicker.js?v=6';
import { exportDashboardToPDF } from './utils/export_engine.js?v=20';
...
document.addEventListener('DOMContentLoaded', () => {
    // Bind Export Button Listener ONCE
